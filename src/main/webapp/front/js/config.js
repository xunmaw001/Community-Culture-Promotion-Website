...
{
	name: '社区新闻',
	url: './pages/shequxinwen/list.jsp'
}, 
{
	name: '社区公告',
	url: './pages/shequgonggao/list.jsp'
}, 
{
	name: '社区活动',
...
{
	name: '医疗服务',
	url: './pages/yiliaofuwu/list.jsp'
}, 
{
	name: '社区美食',
	url: './pages/shequmeishi/list.jsp'
}, 
{
	name: '家政服务',
...
var adminurl =  "http://localhost:8080/jspm9w23w/index.jsp";
