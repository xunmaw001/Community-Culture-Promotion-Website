...
<body>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">社区新闻展示</span>
          ...
          <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
            <div class="ng-incontlst-doc ng-incontlst-doc-show">
              <div class="row">
                <div class="ng-incontlst-col" v-for="(item,index) in shequxinwenList" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    <div class="ng-incontlst-img ng-oa ng-fault">
                      <a href="javascript:void(0);" @click="jump('../shequxinwen/detail.jsp?id='+item.id)">
                        <img :src="item.xinwentupian?item.xinwentupian.split(',')[0]:''" />
                      </a>
                    </div>
                    <div class="ng-fault ng-container">
                      <div class="ng-incontlst-tit">
                        <p>{{item.xinwenbiaoti}}</p>
                        <p style="color: red;" v-if="item.price">{{item.price}} RMB</p>
                        <span></span>
                      </div>
                      <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../shequxinwen/detail.jsp?id='+item.id)">查看详情</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">社区活动展示</span>
              <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            <span class="ng-inmod-thebor" aos="fade-up"></span>
          </div>
          ...
          <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
            <div class="ng-incontlst-doc ng-incontlst-doc-show">
              <div class="row">
                <div class="ng-incontlst-col" v-for="(item,index) in shequhuodongList" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    <div class="ng-incontlst-img ng-oa ng-fault">
                      <a href="javascript:void(0);" @click="jump('../shequhuodong/detail.jsp?id='+item.id)">
                        <img :src="item.huodongtupian?item.huodongtupian.split(',')[0]:''" />
                      </a>
                    </div>
                    <div class="ng-fault ng-container">
                      <div class="ng-incontlst-tit">
                        <p>{{item.huodongmingcheng}}</p>
                        <p style="color: red;" v-if="item.price">{{item.price}} RMB</p>
                        <span></span>
                      </div>
                      <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../shequhuodong/detail.jsp?id='+item.id)">查看详情</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">医疗服务展示</span>
              <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            <span class="ng-inmod-thebor" aos="fade-up"></span>
          </div>
          ...
          <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
            <div class="ng-incontlst-doc ng-incontlst-doc-show">
              <div class="row">
                <div class="ng-incontlst-col" v-for="(item,index) in yiliaofuwuList" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    <div class="ng-incontlst-img ng-oa ng-fault">
                      <a href="javascript:void(0);" @click="jump('../yiliaofuwu/detail.jsp?id='+item.id)">
                        <img :src="item.yiyuantupian?item.yiyuantupian.split(',')[0]:''" />
                      </a>
                    </div>
                    <div class="ng-fault ng-container">
                      <div class="ng-incontlst-tit">
                        <p>{{item.yiyuanmingcheng}}</p>
                        <p style="color: red;" v-if="item.price">{{item.price}} RMB</p>
                        <span></span>
                      </div>
                      <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../yiliaofuwu/detail.jsp?id='+item.id)">查看详情</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">社区美食展示</span>
              <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            <span class="ng-inmod-thebor" aos="fade-up"></span>
          </div>
          ...
          <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
            <div class="ng-incontlst-doc ng-incontlst-doc-show">
              <div class="row">
                <div class="ng-incontlst-col" v-for="(item,index) in shequmeishiList" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    <div class="ng-incontlst-img ng-oa ng-fault">
                      <a href="javascript:void(0);" @click="jump('../shequmeishi/detail.jsp?id='+item.id)">
                        <img :src="item.meishitupian?item.meishitupian.split(',')[0]:''" />
                      </a>
                    </div>
                    <div class="ng-fault ng-container">
                      <div class="ng-incontlst-tit">
                        <p>{{item.dianpumingcheng}}</p>
                        <p style="color: red;" v-if="item.price">{{item.price}} RMB</p>
                        <span></span>
                      </div>
                      <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../shequmeishi/detail.jsp?id='+item.id)">查看详情</a>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script type="text/javascript">
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`shequxinwen/list`, 'get', {
        page: 1,
        limit: 10
      }, function(res) {
        vue.shequxinwenList = res.data.list;
        vue.$nextTick(()=>{
          window.xznResize();
        });
      });
      http.request(`shequhuodong/list`, 'get', {
        page: 1,
        limit: 10
      }, function(res) {
        vue.shequhuodongList = res.data.list;
        vue.$nextTick(()=>{
          window.xznResize();
        });
      });
      http.request(`yiliaofuwu/list`, 'get', {
        page: 1,
        limit: 10
      }, function(res) {
        vue.yiliaofuwuList = res.data.list;
        vue.$nextTick(()=>{
          window.xznResize();
        });
      });
      http.request(`shequmeishi/list`, 'get', {
        page: 1,
        limit: 10
      }, function(res) {
        vue.shequmeishiList = res.data.list;
        vue.$nextTick(()=>{
          window.xznResize();
        });
      });
