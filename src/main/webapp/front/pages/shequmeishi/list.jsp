        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">社区美食展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            ...
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="dianpumingcheng" id="dianpumingcheng" placeholder="店铺名称" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">经营类型</label>
                <div class="layui-input-inline">
                  <input type="text" name="jingyingleixing" id="jingyingleixing" placeholder="经营类型" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('shequmeishi','新增')" @click="jump('../shequmeishi/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../shequmeishi/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-prslist-tit" @click="jump('../shequmeishi/detail.jsp?id='+item.id)"><span>{{item.dianpumingcheng}}</span></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#jingyingleixing').val()) {
          param['jingyingleixing'] = jquery('#jingyingleixing').val() ? '%' + jquery('#jingyingleixing').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('shequmeishi/list', 'get', param, function(res) {
