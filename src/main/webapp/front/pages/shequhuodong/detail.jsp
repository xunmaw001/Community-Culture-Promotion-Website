				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('shequhuodong','活动报名')" @click="onAcrossTap('huodongbaoming')" type="button" class="layui-btn">
								活动报名
							</button>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`shequhuodong`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.huodongmingcheng;
																				// 轮播图片
					vue.swiperList = vue.detail.huodongtupian ? vue.detail.huodongtupian.split(",") : [];
																																																																																					var swiperItemHtml = '';
