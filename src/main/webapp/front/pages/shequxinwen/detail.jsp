				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div class="layui-tab-content">
								...
								<div v-html="detail.xinwenneirong"></div>
							</div>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`shequxinwen`);
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					...
					vue.detail = res.data
															vue.title = vue.detail.xinwenbiaoti;
																																																		// 轮播图片
					vue.swiperList = vue.detail.xinwentupian ? vue.detail.xinwentupian.split(",") : [];
																									var swiperItemHtml = '';
