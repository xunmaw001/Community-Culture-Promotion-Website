				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="fuwuleixing" id="fuwuleixing" placeholder="服务类型" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">服务价格</label>
							<div class="layui-input-block">
								<input type="text" name="fuwujiage" id="fuwujiage" placeholder="服务价格" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">家政电话</label>
							<div class="layui-input-block">
								<input type="text" name="jiazhengdianhua" id="jiazhengdianhua" placeholder="家政电话" autocomplete="off" class="layui-input">
							</div>
						</div>
