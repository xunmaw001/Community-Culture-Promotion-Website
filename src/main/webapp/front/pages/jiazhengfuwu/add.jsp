		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.fuwuleixing" type="text" name="fuwuleixing" id="fuwuleixing" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">服务价格：</label>
						<div class="layui-input-block">
							<input v-model="detail.fuwujiage" type="text" name="fuwujiage" id="fuwujiage" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">家政电话：</label>
						<div class="layui-input-block">
							<input v-model="detail.jiazhengdianhua" type="text" name="jiazhengdianhua" id="jiazhengdianhua" autocomplete="off" class="layui-input">
						</div>
					</div>
