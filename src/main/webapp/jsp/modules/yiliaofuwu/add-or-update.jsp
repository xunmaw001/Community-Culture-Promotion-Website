...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑医疗服务</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑医疗服务</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">医疗服务信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>医院名称</label>
										<input id="yiyuanmingcheng" name="yiyuanmingcheng" class="form-control" placeholder="医院名称">
									</div>
									<div class="form-group col-md-6">
										<label>医院地址</label>
										<input id="yiyuandizhi" name="yiyuandizhi" class="form-control" placeholder="医院地址">
									</div>
									<div class="form-group col-md-6">
										<label>医院图片</label>
										<div><img id="yiyuantupianImg" src="" width="100" height="100">
										<div class="upload">选择文件<input name="file" type="file" id="yiyuantupianupload" class="form-control-file"></div>
										<input name="yiyuantupian" id="yiyuantupian-input" type="hidden"></div>
									</div>
									<div class="form-group col-md-6">
										<label>联系人</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yiliaofuwu/info/" + id,
		...
		// 文件上传
		function upload(){
			$('#yiyuantupianupload').fileupload({
				url: baseUrl + 'file/upload',
				headers:{ token: window.sessionStorage.getItem("token")},
				dataType: 'json',
				done: function (e, data) {				
					document.getElementById('yiyuantupian-input').setAttribute('value',baseUrl+"upload/"+data.result.file);
					if(document.getElementById('yiyuantupianFileName') != null){
						document.getElementById('yiyuantupianFileName').innerHTML = "上传成功!";
					}				
					$("#yiyuantupianImg").attr("src",baseUrl+"upload/"+data.result.file);								
				}
			});
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("yiliaofuwu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yiliaofuwu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#yiyuandizhi").val(ruleForm.yiyuandizhi);	
			$("#yiyuantupian-input").val(ruleForm.yiyuantupian);
		...
		//图片显示
		function showImg(){
			var yiyuantupianFileName = "\"" + ruleForm.yiyuantupian + "\"";
			$("#yiyuantupianImg").attr("src",ruleForm.yiyuantupian);
		}		
		//跨表
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yiyuandizhi != null && res.data.yiyuandizhi != ''){

					$("#yiyuandizhi").val(res.data.yiyuandizhi);
					}
					if(res.data != null && res.data != '' && res.data.yiyuantupian != null && res.data.yiyuantupian != ''){

					$("#yiyuantupianImg").attr("src",res.data.yiyuantupian);
					$("#yiyuantupian-input").val(res.data.yiyuantupian);
					}
