								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<div id="yuyueshijianDate" class="input-append date form_datetime">
											<input id="yuyueshijian-input" name="yuyueshijian" size="15" type="text" readonly>
	...
	<script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("jiazhengyuyue/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jiazhengyuyue/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
