		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑家政预约</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑家政预约</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">家政预约信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="jiazhengxingming" name="jiazhengxingming" class="form-control" v-model="ruleForm.jiazhengxingming" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>服务类型</label>
									...
									<input id="fuwujiage" name="fuwujiage" class="form-control" v-model="ruleForm.fuwujiage" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>预约时间</label>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jiazhengyuyue/info/" + id,
