...
public class JiazhengyuyueController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,JiazhengyuyueEntity jiazhengyuyue, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			jiazhengyuyue.setYonghuming((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,JiazhengyuyueEntity jiazhengyuyue, HttpServletRequest request){
        EntityWrapper<JiazhengyuyueEntity> ew = new EntityWrapper<JiazhengyuyueEntity>();
    	PageUtils page = jiazhengyuyueService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, jiazhengyuyue), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
